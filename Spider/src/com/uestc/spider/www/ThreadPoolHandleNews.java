...
public class ThreadPoolHandleNews{
	...
	/*	for(int i = 0 ; i < 50 ; i++){
		...
		*/
		...
		TaskThreadPool jfjb = new TaskThreadPool("jfjb","cg",new String[]{"style","line-height:140%;"},new String[]{"id","ozoom"},new String[]{"height","25"},new String[]{"解放军报","凡本网注明“来源：中国军网”或“解放军报 ** 电/讯”的文字、图片和音视频作品，版权均属中国军网所有，任何媒体、网站或个人未经本网书面授权不得转载、链接、转贴或以其他方式使用；已经本网书面授权的，在使用时必须注明“来源：中国军网”。"},new String[]{"class","info"},"",
		...
		TaskThreadPool xmwb = new TaskThreadPool("xmwb","cg",new String[]{"title",""},new String[]{"id","ozoom"},new String[]{"span",""},new String[]{"新民晚报","以《新民晚报》强大的资源为依托，融新闻资讯、时尚娱乐、视频直播、名人访谈、数字报纸、交互社区、电子商务为一体，具有图文、视听、互动特色的独家资讯，致力于做到“上海资讯，快速全面”的服务宗旨。"},new String[]{"class","leftrq"},"新民晚报数字报-",
		...
		TaskThreadPool xwcb = new TaskThreadPool("xwcb","cg",new String[]{"title",""},new String[]{"class","content"},new String[]{"h5",""},new String[]{"新闻晨报","主办单位：解放日报报业集团，国内统一刊号：CN31-0070"},new String[]{"h5",""},"",
		...
		TaskThreadPool gzrb = new TaskThreadPool("gzrb","cg",new String[]{"h3",""},new String[]{"class","article"},new String[]{"class","infor"},new String[]{"广州日报","广州日报报业集团,报料热线:(020)81919191,版权所有 不得转载1999-2011©广州市交互式信息网络有限公司（大洋网）,经营许可证编号:粤B2-20040381信息网络传播视听节目许可证：1906152"},new String[]{"class","title"},"",
		...
		TaskThreadPool ycwb = new TaskThreadPool("ycwb","cg",new String[]{"title",""},new String[]{"id","ozoom"},new String[]{"class","time"},new String[]{"羊城晚报","粤B2-20040141 新出网证(粤)字022号 信息网络传播视听节目许可证:1910522 版权所有 [羊城晚报报业集团] 广东羊城晚报数字媒体有限公司"},new String[]{"div",""},"_金羊网",
